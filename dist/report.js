...
export function worstSeverity(result) {
    ...
    return result.findings.reduce((worst, finding) => {
...
export function githubAnnotations(result, failOn = "high") {
...
function formatMarkdown(result) {
    ...
    lines.push("| --- | --- | --- | --- |");
    for (const finding of result.findings) {
        lines.push(`| ${finding.severity} | ${finding.kind} | ${finding.path ?? ""} | ${escapeTable(finding.message)} |`);
    }
    return `${lines.join("\n")}\n`;
}
